...
/**
  ...
  * @note   This function is used to configure the global features of the CRC 
  * @param  CRC_InitStruct: pointer to an ADC_InitTypeDef structure that contains
  *         the configuration information for the specified CRC peripheral.
           	@param  CRC_DIN_Width£ºCRC input selection.
						        @arg  CRC_DATAIN_X8
										@arg  CRC_DATAIN_X16
						@param  CRC_Seed: CRC seed.
					        	This parameter is between 0 and 0xFFFF.
						@param  Bit_Input_Reverse: Input bit sequence reversed.
						        @arg ENABLE
										@arg DISABLE
						@param  Byte_Input_Reverse: Input byte column reversed
						        @arg ENABLE
										@arg DISABLE
						@param  Bit_Output_Reverse: The sequence of output bits is reversed.
						        @arg ENABLE
										@arg DISABLE
						@param  CRC_Poly: CRC polynomial register.
						        This parameter is between 0 and 0xFFFF.
  * @retval None
  */
...
/**
  * @brief  Reload CRC Seed register.
  * @retval None
  */
...
/**
  * @brief  Enables or disable the reverse operation on input data.
  *         The reverse operation on input data is performed on 32-bit.
  * @param  NewState: new state of the reverse operation on output data.
  *         This parameter can be: ENABLE or DISABLE.
             @arg ENABLE
						 @arg DISABLE
...
/**
  * @brief  Initializes the Seed register.
  * @retval None
  */
