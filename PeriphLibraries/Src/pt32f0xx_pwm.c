...
/**
  ...
  *         the specified PWM peripheral.
	          @param  CounterReload: Set the counter reload value.
						        This parameter is between 0 and 0xFFFF.
						@param  ClockSel: Set the PWM clcok.
						        @arg  PCLK
										@arg  HCLK
						@param  Prescaler: Set the Prescaler value.
						        This parameter is between 0 and 0xFF.
						@param  CounterMode: Select the Counter Mode.
						        @arg PWM_CNT_MODE_UP
										@arg PWM_CNT_MODE_DOWN
						@param  CounterDirRv_EN: Select the Counter Mode
						        @arg  PWM_CounterDirRv_EN
										@arg  PWM_CounterDirRv_DIS
  * @retval None
  */		
...
/**
  ...
  *         structure that contains the configuration information for
  *         the specified PWM peripheral.
            @param  Channel: Capture channel.
                    @arg  PWM_CH_1
                    @arg  PWM_CH_2
                    @arg  PWM_CH_3
                    @arg  PWM_CH_4
            @param  OutputMode: Channel comparison output mode selection.
                    @arg  NO_OUTPUT
                    @arg  COMPAER_MODE1
                    @arg  COMPAER_MODE2
                    @arg  COMPAER_MODE3
            @param  ControlN: PWM channel_N enable and disable.  
                    @arg  PWM_CHNCTL_DISABLE
									  @arg  PWM_CHNCTL_ENABLE
            @param  IdleState: The initial value of the channel .  
                    @arg  PWM_IDLE_LOW
                    @arg  PWM_IDLE_HIGH										
            @param  CompareValue: CHx Compare value.
						         This parameter is between 0 and 0xFF.
            @param  DeathTime: Death time
                     This parameter is between 0 and 0xFF.
  * @retval None
  */	
...
/**
  ...
  * @param  PWMx: where x can be 0, 1 to select the PWM peripheral.
            @arg  PWM0
						@arg  PWM1 
  * @param  RepeatTimes: specifies the Match Times to Trigger INT
            This parameter is between 0 and 0xF.
  * @retval None
  */
...
/**
  * @brief  Enable or Disable PWMx brake function
   * @param  PWMx: where x can be 0, 1 to select the PWM peripheral.  
            @arg  PWM0
						@arg  PWM1  
  * @param  NewState: This parameter can be ENABLE or DISABLE.
...
/**
  * @brief  Control the effective level of brake input.
  * @param  PWMx: where x can be 0, 1 to select the PWM peripheral.  
            @arg  PWM0
						@arg  PWM1  
  * @param  BKI_Level: This parameter can be PWM_BKI_HIGHLEVEL or PWM_BKI_LOWLEVEL.
            @arg  PWM_BKI_HIGHLEVEL
						@arg  PWM_BKI_LOWLEVEL 
  * @retval None
  */
...
/**
  * @brief  Enable or Disable the interruption of matching, capturing and braking.
  * @param  PWMx: where x can be 0, 1 to select the PWM peripheral.
            @arg  PWM0
						@arg  PWM1 
...
/**
  * @brief  Check the flag bit of PWM.
  * @param  PWMx: where x can be 0, 1 to select the PWM peripheral.
            @arg  PWM0
						@arg  PWM1 
...
/**
  * @brief  Clear the flag bit of PWM.
  * @param  PWMx: where x can be 0, 1 to select the PWM peripheral.
            @arg  PWM0
						@arg  PWM1 
...
/**
  ...
  *         @arg PWM_CH_3        : 
  *         @arg PWM_CH_4        : 
  * @param  Idle: Specify the Channel output mode  
  *         This parameter can be one of the following values:
