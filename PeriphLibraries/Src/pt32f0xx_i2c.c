/**
 ...
 ============================================================================
   ...
   (#) Enable the NVIC and the corresponding interrupt using the function
       NVIC_Init() if you need to use interrupt mode.
...
/* Slave Mode */
volatile uint8_t I2CWrBuffer[I2C_BUFSIZE];
/* Slave Mode */
volatile uint8_t I2CRdBuffer[I2C_BUFSIZE];        
...
/**
  ...
  *         contains the configuration information for the specified I2C peripheral.
	          @param  I2C_OwnAddress£ºSlave address
						        This parameter is between 0 and 0x7F
						@param  I2C_Ack£ºResponse bit control
  *                 @arg  ENABLE 
  *                 @arg  DISABLE						
						@param  2C_SCLK_DIV£ºFrequency division coefficient of communication clock
						        @arg  I2C_SCLK_DIVX60
										@arg  I2C_SCLK_DIVX120
										@arg  I2C_SCLK_DIVX160
										@arg  I2C_SCLK_DIVX192
										@arg  I2C_SCLK_DIVX244
										@arg  I2C_SCLK_DIVX960
										@arg  I2C_SCLK_DIVX256
						@param  I2C_BroadCast£ºBroadcast addressing enable bit.
						  *     @arg  ENABLE 
  *                 @arg  DISABLE	
  * @retval None
  */
...
/**
  ...
  *                 @arg  ENABLE 
  *                 @arg  DISABLE						
						@param  I2C_SCLK_DIV£ºFrequency division coefficient of communication clock
						        @arg  I2C_SCLK_DIVX60
										@arg  I2C_SCLK_DIVX120
										@arg  I2C_SCLK_DIVX160
										@arg  I2C_SCLK_DIVX192
...
/**
  * @brief  Return the SR register value 
  * @param  I2Cx: where x can be 0 or 1 to select the I2C peripheral.
	          @arg I2C0
						@arg I2C1
  * @retval The value of the SR register.
  */
