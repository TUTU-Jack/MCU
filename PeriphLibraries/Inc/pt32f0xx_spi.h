...
#ifndef __PT32F0XX_SPI_H
#define __PT32F0XX_SPI_H
...
typedef struct
{
  ...
  uint8_t SPI_BaudRatePostPrescaler; /*!< Specifies the Baud Rate prescaler value which will be
                                         used to configure the transmit and receive SCK clock.
                                         This parameter can be a value of @ref SPI_BaudRate_Prescaler
                                         @note The communication clock is derived from the master
                                               clock. The slave clock does not need to be set. */																							 
...
#define IS_SPI_BAUDRATE_PRESCALER(PRESCALER) ((PRESCALER%2) == 0)
																																																																	
#define IS_SPI_BAUDRATE_POSTPRESCALER(POSTPRESCALER) ( POSTPRESCALER <= 0xFF )																							
/**
  * @}
  */
